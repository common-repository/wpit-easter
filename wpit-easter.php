...
Description: Find Catholic Easter date in gregorian calendar and Orthodox Easter date in Julian and Gregorian calendar.
...
function wpit_easter_text_domain(){

	load_plugin_textdomain('wpit-easter', false, basename( dirname( __FILE__ ) ) . '/languages/' );

}


add_action('plugins_loaded', 'wpit_easter_text_domain');
